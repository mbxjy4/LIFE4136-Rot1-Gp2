...
cd /share/BioinfMSc/rotation1/group2/hybrid
unicycler -1 merged_S2_forward.fastq.gz -2 merged_S2_reverse.fastq.gz -l merged_pass_barcode02v2.fastq.gz -o assembly
