...
#SBATCH --job-name=hybrid_annotate
...
cd /share/BioinfMSc/rotation1/group2/hybrid/assembly
prokka --outdir /share/BioinfMSc/rotation1/group2/prokka/prokka_hybrid1 assembly.fasta
