...
#SBATCH --job-name=hybrid06_annotate
...
cd /share/BioinfMSc/rotation1/group2/bar06/hybrid/assembly
prokka --outdir /share/BioinfMSc/rotation1/group2/bar06/prokka/prokka_hybrid1 assembly.fasta
