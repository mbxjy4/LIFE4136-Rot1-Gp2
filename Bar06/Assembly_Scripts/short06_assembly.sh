...
#SBATCH --job-name=short06_assembly
...
cd /share/BioinfMSc/rotation1/group2/bar06/short_merged
unicycler -1 merged_S6_forward.fastq.gz -2 merged_S6_reverse.fastq.gz -o assembly
